# Generated by Django 4.0.3 on 2022-05-05 12:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_code', models.CharField(max_length=10, unique=True, validators=[account.validators.national_code_validator])),
                ('profile_picture', models.ImageField(upload_to='account/')),
                ('address', models.TextField(verbose_name='آدرس')),
                ('data_of_birth', models.DateTimeField(blank=True, null=True, verbose_name='تاریخ تولد')),
